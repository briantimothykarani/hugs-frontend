...
const DeleteStudent = () => {
    ...
    const handleDelete = async () => {
        ...
        setError(null);
        try {
            await axiosInstance.delete(`http://127.0.0.1:8000/api/StudentDelete/${id}/`);
            navigate("/home");
        } catch {
        ...
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 via-purple-600 to-black">
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button onClick={() => navigate("/home")} disabled={loading} className="bg-purple-600 hover:bg-purple-700 disabled:bg-purple-300 text-white font-semibold py-2 px-6 rounded transition">
                        Cancel
                    </button>
                </div>
            </div>
